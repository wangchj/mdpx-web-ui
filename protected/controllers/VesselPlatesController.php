...
class VesselPlatesController extends Controller
{
	/**
	...
	public function actionCreate($vesselSetupId)
	{
		...
		if(isset($_POST['VesselPlates']))
		{
			$model->attributes=$_POST['VesselPlates'];
            $model->vesselSetupId = $vesselSetupId;
	...
	public function actionIndex()
	{
        ...
        $model=new VesselPlates('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['VesselPlates']))
            $model->attributes=$_GET['VesselPlates'];
    ...
    {
        $model=VesselPlates::model()->findByPk(
            array(
