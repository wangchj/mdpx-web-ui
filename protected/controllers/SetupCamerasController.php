...
class SetupCamerasController extends Controller
{
	/**
	...
	public function actionCreate($vesselSetupId)
	{
		...
		if(isset($_POST['SetupCameras']))
		{
			$model->attributes=$_POST['SetupCameras'];
            $model->vesselSetupId = $vesselSetupId;
	...
	public function actionIndex()
	{
        ...
        $model=new SetupCameras('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['SetupCameras']))
            $model->attributes=$_GET['SetupCameras'];
    ...
    {
        $model=SetupCameras::model()->findByPk(
            array(
