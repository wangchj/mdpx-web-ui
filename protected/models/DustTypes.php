...
/**
 * This is the model class for table "DustTypes".
 *
 ...
 */
class DustTypes extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return DustTypes the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'experimentSetups' => array(self::HAS_MANY, 'ExperimentSetup', 'dustType1'),
			'experimentSetups1' => array(self::HAS_MANY, 'ExperimentSetup', 'dustType2'),
		);
	}
